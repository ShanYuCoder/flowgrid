...
- **[MANDATORY]** Write EJS templates to `.flowgrid/templates/` (e.g. `default-layout.ejs`, `breadcrumb-flow.ejs`).
- **[MANDATORY]** Templates MUST accurately reflect project UI Kit (Vuetify → Vuetify component tags; Shadcn → flat design style).
- **[STRICTLY FORBIDDEN]** Do NOT alter anchor comments `<!-- flowgrid-anchor: ... -->` in templates — these are vital data anchors for AI processing.
