...
1. Resolve scope: function id `W-*`/`API-*` under `surfaces/.../CMP-*/<slug>/code/` (legacy `.../modules/CMP-*/` also accepted), `ir/spec.yaml`, optional code paths. Tag business gaps `#missing_info` — do not invent fills.
