...
- Sinh ra bộ 3 file quen thuộc: `01-backend-spec.yaml`, `02-openapi.yaml` (dùng `flowgrid openapi_gen`), và `03-mock-data.yaml`.
...
- Đóng vai trò là cầu nối chuẩn hoá hợp đồng giao tiếp giữa hệ thống FlowGrid và các đối tác bên ngoài (Ví dụ: Cổng thanh toán Stripe, Push Notification Firebase, v.v.).
