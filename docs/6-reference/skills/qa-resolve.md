...
- `flowgrid split` chạy lại để làm mới dữ liệu IR.
...
- Nếu đích sửa đổi là file `01-backend-spec.yaml`, Agent cần gọi tiếp `flowgrid openapi_gen --spec <01>` để cập nhật lại swagger.
