...
export function registerTools(server: McpServer): void {
  ...
  server.tool('artifactgraph_projects',
  ...
  server.tool('artifactgraph_rebuild',
   ...
   */
  server.tool('artifactgraph_analyze',
  ...
  server.tool('artifactgraph_grill_check',
   ...
   */
  server.tool('artifactgraph_parity_check',
  ...
  server.tool('artifactgraph_remember',
  ...
  server.tool('artifactgraph_allowlist_check',
  ...
  server.tool('artifactgraph_gaps',
   ...
   */
  server.tool('artifactgraph_api_reuse_check',
   ...
   */
  server.tool('artifactgraph_suggest_tags',
  ...
  server.tool('artifactgraph_status',
