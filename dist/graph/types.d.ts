...
export type GapKind = 'needs-component' | 'needs-ui' | 'needs-common' | 'needs-unit-test' | 'needs-e2e'
/** Alias-oriented: missing testcase YAML / e2e bundle (prefer needs-e2e when registry miss). */
 | 'needs-testcase' | 'missing-hashtag' | 'missing-codegen-profile' | 'registry-miss' | 'handoff'
