 ...
 */
export function inferSurfaceFromRepoPath(absPath, repoRoot) {
...
export function isLegacyModulesCmpPath(filePath) {
    return /(?:^|\/)surfaces\/[^/]+\/modules\/CMP-/i.test(filePath.split(path.sep).join('/'));
}
//# sourceMappingURL=surface-paths.js.map